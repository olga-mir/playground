...
if [ "$SKIP_ARGO" = false ]; then
    ...
    # Apply ArgoCD configuration plugin
...
echo "Waiting for Crossplane to be installed in GKE Management cluster (by Composition)..."
echo "This might take a few minutes. Monitor the cluster composition status."
